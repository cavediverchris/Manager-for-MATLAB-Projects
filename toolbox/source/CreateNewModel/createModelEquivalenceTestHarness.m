%% Create Model Equivalence Test Harness
%       This function creates a Test harness for the model, model_name,
%       with name th_name that will enable the user to execute tests in
%       parallel for models in simulation and with generated code to
